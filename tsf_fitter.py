...
# VARIABLES   
freqs = np.arange(12, 500, 0.03125)

Tvals = [168* 24 * 60 * 60,            365.25* 24 * 60 * 60,        365.25*2* 24 * 60 * 60, 
        365.25*5* 24 * 60 * 60,        365.25*10* 24* 60 * 60] 
...
for kk, T in enumerate(Tvals): 
    ...
    pickle.dump([freqs, data, signal, fit_omega, fit_results_omega], open(f'{sig_type}_signal_data_{T/(24 * 60 * 60)}_{noise}.pkl', 'wb'))
